...
namespace Paint
{
    public partial class MainPaint : RibbonForm
    {
        ...
        private DanhSachDoiTuong dsdt; // Danh sách các hình khi undo
        ...
        private bool hienThiChuot;
        public static int ChieuDaiKhungVe; //Chiều dài khung vẽ
        public static int ChieuRongKhungVe; //Chiều rộng khung vẽ
        ...
        private void Open_Click(object sender, ItemClickEventArgs e)
        {
            ...
            openFileDialog1.Filter = "PNG (*.png)|*.png|BMP (*.bmp)|*.bmp|JPG (*.jpg)|*.jpg";
        ...
        // Lưu hình vẽ với tên khác
        private void SaveAs_Click(object sender, ItemClickEventArgs e)
        {
            saveFileDialog1.Title = "Save As";
            saveFileDialog1.Filter = "PNG (*.png)|*.png|BMP (*.bmp)|*.bmp|JPG (*.jpg)|*.jpg";
        ...
        {
            Cursor = new Cursor(Properties.Resources.Zoom_out1.Handle);
            kiemTraNutNhan = 1;
            idHinhHienTai = 0;
            hinh = null;
        }
        ...
        {
            Cursor = new Cursor(Properties.Resources.Zoom_in1.Handle);
            kiemTraNutNhan = 2;
            idHinhHienTai = 0;
            hinh = null;
        }
        ...
        {
            Cursor = new Cursor(Properties.Resources.Delete16.Handle);
            kiemTraNutNhan = 3;
            idHinhHienTai = 0;
            hinh = null;
        }
        ...
        // Xoay đối tượng
        private void btnRotate_Click(object sender, ItemClickEventArgs e)
        {
            Cursor = new Cursor(Properties.Resources.Rotate1.Handle);
            kiemTraNutNhan = 4;
            idHinhHienTai = 0;
            hinh = null;
        }

        // Chức năng thay đổi kích thước khung vẽ
        private void btnThayDoiKichThuoc_Click(object sender, ItemClickEventArgs e)
        {
            ...
            {
                hinhNenNoi = new Bitmap(hinhNenNoi, ChieuDaiKhungVe, ChieuRongKhungVe);
                pictureBox1.Refresh();
            }
        }

        // Chức năng upload hình lên facebook
        ...
        private void btnUndo_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            {
                int i = danhSachDoiTuong.danhSachHinh.ToArray().Length - 1;
                hinh = (danhSachDoiTuong.danhSachHinh.ToArray())[i];
                dsdt.danhSachHinh.Insert(dsdt.danhSachHinh.Count, hinh);
        ...
        {
            if (dsdt.danhSachHinh.Count > 0)
            {
                int i = dsdt.danhSachHinh.ToArray().Length - 1;
                hinh = (dsdt.danhSachHinh.ToArray())[i];
                danhSachDoiTuong.danhSachHinh.Insert(danhSachDoiTuong.danhSachHinh.Count, hinh);
                dsdt.XoaPhanTuCuoi();
            }
            else
            {
                MessageBox.Show("Không thể tiếp tục Redo", "Thông báo!");
            }
            pictureBox1.Refresh();   
        }
        ...
        private void btnDoiTuong_Click(object sender, ItemClickEventArgs e)
        {
            ...
            if (idHinhHienTai == 15)
            {
                if (fontDialog1.ShowDialog() == DialogResult.OK)
                    phongChu = fontDialog1.Font;
            }

            if (idHinhHienTai <= 11 && idHinhHienTai >= 3)
                Cursor = new Cursor(Properties.Resources.Pencil16.Handle);
            else if (idHinhHienTai == 2)
                Cursor = new Cursor(Properties.Resources.Cursor16.Handle);
            else if (idHinhHienTai == 14)
                Cursor = new Cursor(Properties.Resources.Erasor16.Handle);
            else if (idHinhHienTai == 20)
                Cursor = new Cursor(Properties.Resources.Fill24.Handle);
            pictureBox1.Refresh();
        }
        ...
        private void Picture_Mouse_Move(object sender, MouseEventArgs e)
        {
            ...
            else
            {
                ...
                if (hinh != null)
                {
                    ...
                    else if (hinh.kiemTraViTriDiemNhan(e.Location) < 0 && hienThiChuot == true && idHinhHienTai <= 11 && idHinhHienTai >= 3)
                        Cursor = new Cursor(Properties.Resources.Pencil16.Handle);
                    else if (hinh.kiemTraViTriDiemNhan(e.Location) < 0 && idHinhHienTai == 1)
                        Cursor = Cursors.Default;
                }
